  ...
  return (
    <div className="flex justify-between items-center p-2 lg:p-0">
      <Sheet>
        ...
        <SheetContent side="left" className=" p-5 bg-white flex flex-col gap-4">
          ...
          <ScrollArea className="my-4 h-[calc(100vh-8rem)] ">
            <div className="flex flex-col gap-8 ">
              ...
              <SignOutButton>
                <Button
                  variant="ghost"
                  className="flex gap-3 justify-start p-0 hover:bg-white stroke-zinc-600  text-zinc-600 text-base font-medium "
                >
      ...
      <div className="w-72 h-screen gap-8 px-6 pt-6 pb-8 bg-white rounded-tr-lg rounded-br-lg border-r border-gray-100 flex-col items-start hidden lg:inline-flex ">
        <Link href="/dashboard">
          <SiteLogo />
        </Link>
...
export const NavItem: React.FC<NavItemProps> = ({
  ...
  return (
    <Link href={href}>
      ...
      >
        <Icon
          className={cn("w-6 h-6 stroke-zinc-600 ", {
